...
const WA_NUMBER = "923452615590"
const WA_MESSAGE = "Hi Nyrvex! I'd like to discuss a project."
...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[210] flex items-center gap-3">
      ...
      >
        <span style={{ color: "#25D366", marginRight: "0.35rem" }}>●</span>
        Chat on WhatsApp
      </div>
      ...
      <div className="relative flex items-center justify-center">
        ...
        <a
          ...
          aria-label="Chat with Nyrvex on WhatsApp"
          ...
          style={{
            ...
            boxShadow: hovered
              ? "0 0 0 4px rgba(37,211,102,0.2), 0 8px 24px rgba(37,211,102,0.45)"
