...
export default function ProjectsPage() {
  const projects = [
    ...
    },
    {
      ...
      description: "A mobile application for patient management, appointment scheduling, and medical record access.",
      image: "/placeholder.svg?height=300&width=400",
    ...
    },
    {
      ...
      description: "An analytics dashboard for real-time financial data visualization and reporting.",
      image: "/placeholder.svg?height=300&width=400",
      category: "Web Development",
    ...
    },
    {
      ...
      description: "A comprehensive system for tracking inventory, managing suppliers, and optimizing stock levels.",
      image: "/placeholder.svg?height=300&width=400",
    ...
    },
    {
      ...
      description: "A platform for property listings, virtual tours, and real estate agent management.",
      image: "/placeholder.svg?height=300&width=400",
      category: "Web Development",
    ...
    },
    {
      ...
      description: "A mobile app for tracking workouts, nutrition, and fitness progress with social features.",
      image: "/placeholder.svg?height=300&width=400",
      category: "Mobile Development",
